  ...
  return (
    <main className="module-two-screen">
      ...
      <nav className={`topbar module-topbar module-two-topbar ${styles.topbar}`} aria-label="Navegação do módulo">
        ...
        <div className={`screen-nav ${styles.topLinks}`}><Link className="back-link" href="/modulo-2/comportamentos-e-resultados">← Tela anterior</Link><Link className="back-link" href="/modulo-2/normalizacao-do-desvio">Próxima tela →</Link><span className="module-two-step">Módulo 2 · Tela 15</span></div>
      </nav>
      <div className={styles.content}>
        ...
        <div className={styles.resourceLinks}><Link href="/modulo-2/roteiro-normalizacao-do-desvio">Ver o roteiro revisado das quatro histórias →</Link></div>
        <div className={styles.cinema}>
          ...
          <span id="video-description" className={styles.videoCaption}>Versão anterior, em substituição. O roteiro revisado inclui ponte real, água derramada, portaria e EPI; o novo filme ainda não foi gerado.</span>
        </div>
        ...
        <details className={`module-two-glass-panel ${styles.panel} ${styles.transcript}`}>
          <summary>Ler a narração da versão anterior</summary>
          ...
          <div className={styles.resourceLinks}><a href="/videos/modulo-2/normalizacao-do-desvio/roteiro-e-prompt.md" download>Baixar roteiro e prompts revisados</a><a href="/videos/modulo-2/normalizacao-do-desvio/filme.mp4">Abrir o vídeo anterior</a></div>
        </details>
