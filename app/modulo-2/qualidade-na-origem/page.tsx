  ...
  return (
    <main className="module-two-screen" id="inicio">
      ...
      <nav className={`topbar module-topbar module-two-topbar ${shared.topbar}`} aria-label="Navegação do módulo">
        ...
        <div className={`screen-nav ${shared.topLinks}`}><Link className="back-link" href="/modulo-2/cafe-5-minutos">← Pausa para o café</Link><Link className="back-link" href="/modulo-2">Início do módulo</Link><span className="module-two-step">Módulo 2 · Tela 17</span></div>
      </nav>
      <div className={`${shared.content} ${styles.content}`}>
        ...
        <footer className={shared.footer}><Link className="module-two-button" href="/modulo-2/cafe-5-minutos">← Pausa para o café</Link><span>Parceria do Grupo WD e Ramos Consultoria</span><a className="module-two-button" href="#inicio">Voltar ao topo ↑</a></footer>
      </div>
    </main>
  );
}
