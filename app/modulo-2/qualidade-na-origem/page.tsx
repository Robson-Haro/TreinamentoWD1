  ...
  return (
    <main className="module-two-screen" id="inicio">
      ...
      <nav className={`topbar module-topbar module-two-topbar ${shared.topbar}`} aria-label="Navegação do módulo">
        ...
        <div className={`screen-nav ${shared.topLinks}`}><Link className="back-link" href="/modulo-2/video-qualidade-na-origem">← Vídeos da Toyota</Link><Link className="back-link" href="/modulo-2">Início do módulo</Link><span className="module-two-step">Módulo 2 · Tela 18</span></div>
      </nav>
