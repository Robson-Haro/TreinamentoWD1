...
export default function CaseQRCode() {
  const [caseUrl, setCaseUrl] = useState(
    "https://treinamento-wd-1.vercel.app/modulo-2/operacao-em-alerta"
  );

  useEffect(() => {
    setCaseUrl(`${window.location.origin}/modulo-2/operacao-em-alerta`);
  }, []);

  const qrUrl =
    "https://quickchart.io/qr?size=700&margin=2&dark=202227&light=e8eaed&text=" +
  ...
  return (
    <aside className="case-access-card">
      ...
      <code>treinamento-wd-1.vercel.app/modulo-2/operacao-em-alerta</code>
    </aside>
  );
}
